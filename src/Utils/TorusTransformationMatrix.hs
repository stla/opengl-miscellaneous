module Utils.TorusTransformationMatrix
  (torusTransformationMatrix)
  where
...
circleCenterRadius :: Floating a => V3 a -> V3 a -> V3 a
                   -> ((V3 a, a), V3 a)
...
-- | the transformation matrix for the torus passing through three points
torusTransformationMatrix :: (Real a, Floating a) => V3 a -> V3 a -> V3 a
                     -> ([a], GLdouble)
torusTransformationMatrix p1 p2 p3 =
